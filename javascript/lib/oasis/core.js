import { Quaternion, Vector3, Matrix3x3, Matrix, MathUtil, Vector4, Vector2, Color, BoundingBox, BoundingFrustum, Plane, BoundingSphere, Ray } from './math.js';
...
var mobile_material_frag = "#define GLSLIFY 1\nuniform vec4 u_ambientColor;uniform vec4 u_emissiveColor;uniform vec4 u_diffuseColor;uniform vec4 u_specularColor;uniform float u_shininess;\n#ifdef O3_AMBIENT_TEXTURE\nuniform sampler2D u_ambientTexture;\n#endif\n#ifdef O3_EMISSIVE_TEXTURE\nuniform sampler2D u_emissiveTexture;\n#endif\n#ifdef O3_DIFFUSE_TEXTURE\nuniform sampler2D u_diffuseTexture;\n#endif\n#ifdef O3_SPECULAR_TEXTURE\nuniform sampler2D u_specularTexture;\n#endif\n"; // eslint-disable-line
...
Scene.prototype.raycast = function (_ray, _outPos, tag) {
  if (tag === void 0) {
...
var BlinnPhongMaterial = /*#__PURE__*/function (_Material) {
  ...
  function BlinnPhongMaterial(engine) {
    ...
    _this.ambientColor = _this._ambientColor;
...
var PBRMaterial = /*#__PURE__*/function (_Material) {
  ...
  function PBRMaterial(engine) {
    ...
    _this.isMetallicWorkflow = _this._isMetallicWorkflow;
...
var ParticleRenderer = /*#__PURE__*/function (_GeometryRenderer) {
  ...
  function ParticleRenderer(props) {
    ...
    _this._color = new Vector3(1, 1, 1);
  ...
  _proto._updateSingleBuffer = function _updateSingleBuffer(i) {
    ...
    if (_updateDirtyFlag & DirtyFlagType.Color) {
      ...
      vertices[k0 + 9] = vertices[k1 + 9] = vertices[k2 + 9] = vertices[k3 + 9] = MathUtil.clamp(_color.x + getRandom() * _colorRandomness, 0, 1);
      vertices[k0 + 10] = vertices[k1 + 10] = vertices[k2 + 10] = vertices[k3 + 10] = MathUtil.clamp(_color.y + getRandom() * _colorRandomness, 0, 1);
      vertices[k0 + 11] = vertices[k1 + 11] = vertices[k2 + 11] = vertices[k3 + 11] = MathUtil.clamp(_color.z + getRandom() * _colorRandomness, 0, 1);
    }
