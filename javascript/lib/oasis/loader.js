import { resourceLoader, AssetType, AssetPromise, Loader, VertexElement, DataType, IndexFormat, VertexElementFormat, Material, Logger, SkinnedMeshRenderer, MeshRenderer, Entity, Animation, BlinnPhongMaterial, PBRMaterial, EngineObject, AlphaMode, Skin, Mesh, AnimationClip, InterpolationType, Camera, Primitive, SubPrimitive, PrimitiveTopology, Buffer, BufferBindFlag, BufferUsage, IndexBufferBinding, Texture2D, GLCompressedTextureInternalFormat, TextureFormat, TextureCubeMap, TextureCubeFace, Component, GLCapabilityType, Texture, ObjectValues, EventDispatcher } from './core.js';
import { Color, Matrix, Vector3, Quaternion, Vector4, Vector2 } from './math.js';
...
function parseMaterial(gltfMaterial, resources) {
  var gltf = resources.gltf;
      resources.asset;
  var material = new PBRMaterial(resources.engine);
