import { Logger, Entity, EngineFeature, Engine } from './oasis-engine.js';
...
function log() {
  ...
  Logger.info.apply(Logger, ["🚀 [o3-engine-stats]"].concat(args));
}
function errorLog() {
  ...
  Logger.error.apply(Logger, ["🚀 [o3-engine-stats]"].concat(args));
}
